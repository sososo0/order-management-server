...
public class ProductServiceUpdateUnitTest extends BaseProductServiceUnitTest {
    ...
    void setUp() {
        ...
        existProduct = TestDataForUnitTest.createProduct(productUuid, productName, price, shop);
    }
    ...
    public void updateAllFieldsProduct_successTest() {
        ...
        Product updatedAllProduct = TestDataForUnitTest.createProduct(existProduct.getProductUuid(),
    ...
    public void updatePartialFieldsProduct_successTest() {
        // Given
        Integer updatePrice = 19_000;
        Product updatedPartialProduct = TestDataForUnitTest.createProduct(
    ...
    public void updateProduct_failureTest_notShopOwner() {
        // Given
        User otherOwner = TestDataForUnitTest.createUser("owner2", Role.OWNER, regionEntity);
        Shop otherShop = TestDataForUnitTest.createShop("other-shop-uuid", shopCategory, "소현이네 bbq",
            otherOwner.getUserStringId());
        Product product = TestDataForUnitTest.createProduct("other-product-uuid", "황금올리브", 23_000,
            otherShop);
    ...
    public void updateProduct_failureTest_deletedProduct() {
        // Given
        Product product = TestDataForUnitTest.createDeleteProduct(existProduct.getProductUuid(),
